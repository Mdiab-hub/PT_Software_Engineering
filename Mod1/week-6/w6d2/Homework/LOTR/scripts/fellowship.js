...
const makeMiddleEarth = () => {
  ...
  for (let i = 0; i < lands.length; i++){
    console.log(lands[i])
    const lands = document.setAttribute("id", lands[i])
    const h1 = document.innerText(lands[i])
    document.appendChild(lands)
...
const leaveTheShire = () => {
  ...
  const movingHobbits = document.setAttribute("The-shire")
  document.children("ul")
...
const beautifulStranger = () => {
  ...
  document.isEqualNode(3)
  document.eq(3)
  document.innerText("Aragorn")
};
